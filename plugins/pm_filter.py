...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❓ How to Use ❓', callback_data='help1')
            ],[
            InlineKeyboardButton('« Back', callback_data='start'),
